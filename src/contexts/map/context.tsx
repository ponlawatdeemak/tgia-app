...
export type SourceSpecificationAndName =
...
export interface MapContextFunction<T = MapType> {
  setMap?: (map?: T) => void
  setSources: Dispatch<
    SetStateAction<SourceSpecificationAndName[][] | undefined>
  >
...
export function MapProvider({
  ...
  const [sources, setSources] = useState<
    SourceSpecificationAndName[][] | undefined
  >(defaultSources)
  ...
  }, [sources, map, visibility, layerIds, selectedSource])
