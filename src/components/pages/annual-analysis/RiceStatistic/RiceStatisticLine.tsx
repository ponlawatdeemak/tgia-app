...
interface PlantStatisticLineProps {
	riceLineColumns?: any
	riceLineColorArr?: any
	lineCategoriesArr?: any
}

const RiceStatisticLine: React.FC<PlantStatisticLineProps> = ({
	riceLineColumns,
	riceLineColorArr,
	lineCategoriesArr,
}) => {
	...
	}, [riceLineColumns, riceLineColorArr, language])
	...
	}, [riceLineColumns, riceLineColorArr, lineCategoriesArr, language])
...
export default RiceStatisticLine
